...
#define _PTOS_INPUT_MOUSEEND 8
#define _PTOS_INPUT_KEYBEGIN 9
#define _PTOS_INPUT_KEYEND 166
#define _PTOS_INPUT_KEYPADBEGIN 13
...
namespace PTOS {
	...
	namespace Inputs {
		enum Code {
			...
			CODE_MOUSE_0 = _PTOS_INPUT_MOUSEBEGIN,
			CODE_MOUSE_1,
			CODE_MOUSE_2,
			CODE_MOUSE_3,
			CODE_MOUSE_4,
			...
			CODE_MOUSE_6,
			CODE_MOUSE_7,
			CODE_MOUSE_8 = _PTOS_INPUT_MOUSEEND,
			CODE_MOUSE_LEFT = CODE_MOUSE_0,
			CODE_MOUSE_RIGHT = CODE_MOUSE_1,
			CODE_MOUSE_MIDDLE = CODE_MOUSE_2,
			...
			CODE_KEY_KP_8,
			CODE_KEY_KP_9,
			CODE_KEY_KP_DOWN = CODE_KEY_KP_2,
			CODE_KEY_KP_LEFT = CODE_KEY_KP_4,
			CODE_KEY_KP_RIGHT = CODE_KEY_KP_6,
			CODE_KEY_KP_UP = CODE_KEY_KP_8,
			CODE_KEY_KP_PERIOD,
			CODE_KEY_KP_DIVIDE,
